...
<body>
	<table>
		...
		<tr>
			<td>Nomor Induk</td>
			<td>:</td>
			<td><input type="text" name="ni" placeholder="Masukan Nomer Induk" value="<?php echo $no_induk; ?>" disabled></td>
			<td><input hidden="" type="text" name="ni" value="<?php echo $no_induk; ?>"></td>
		</tr>
		<tr>
			<td>Nama</td>
			<td>:</td>
			<td><input type="text" required name="nama" placeholder="Masukan Nama Anda" value="<?php echo $nama; ?>"></td>
		</tr>
		<tr>
			<td>Alamat</td>
			<td>:</td>
